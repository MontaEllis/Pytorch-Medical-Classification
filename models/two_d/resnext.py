...
def resnext101(class_names):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 23, 3], class_names=class_names)

def resnext152(class_names):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 36, 3], class_names=class_names)
...
if __name__ == "__main__":
    ...
    model = resnext152(class_names=2).to(device)
